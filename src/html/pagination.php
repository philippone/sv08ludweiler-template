...
function pagination_list_render($list)
{
	...
	$html = '<ul class="pagination-list center">';
...
function pagination_item_active(&$item)
{
	...
	{
		$display = '<i class="material-icons waves-effect">skip_previous</i>';
	}

	// Check for "Prev" item
	if ($item->text == JText::_('JPREV'))
	{
		$display = '<i class="material-icons waves-effect">chevron_left</i>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		$display = '<i class="material-icons waves-effect">chevron_right</i>';
	}

	// Check for "End" item
	if ($item->text == JText::_('JLIB_HTML_END'))
	{
		$display = '<i class="material-icons waves-effect">skip_next</i>';
	}
	...
	{
		$display = $item->text;
		$class   = ' class="hidden-phone waves-effect"';
	}
